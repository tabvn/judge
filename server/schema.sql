...
CREATE TABLE `contest_problem` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `problem_id` (`problem_id`,`contest_id`),
  KEY `contest_id` (`contest_id`),
  CONSTRAINT `contest_problem_ibfk_1` FOREIGN KEY (`problem_id`) REFERENCES `problems` (`id`) ON DELETE CASCADE,
  CONSTRAINT `contest_problem_ibfk_2` FOREIGN KEY (`contest_id`) REFERENCES `contests` (`id`) ON DELETE CASCADE
...
INSERT INTO `contest_problem` VALUES (24,12,5,10),(25,24,5,10),(26,11,5,50);
...
-- Dump completed on 2018-12-07 16:37:03
